...
const TYPE_CONFIG: Record<string, { bg: string; color: string; Icon: LucideIcon }> = {
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {[
                ...
                { label: "Emails sent",      value: entries.filter((e: any) => e.type === "email_sent").length,     color: "text-blue-600" },
                { label: "Replies received", value: entries.filter((e: any) => e.type === "email_received").length, color: "text-emerald-600" },
                { label: "Notes logged",     value: entries.filter((e: any) => e.type === "note").length,           color: "text-amber-600" },
              ].map((s) => (
