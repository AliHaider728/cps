...
export default function Team() {
  ...
  const SUMMARY = [
    ...
    { icon: Wifi,   label: "Synced",      value: members.filter((m: any) => m.outlookConnected).length,        bg: "bg-emerald-50",color: "text-emerald-600" },
    { icon: Mail,   label: "Total Emails",value: members.reduce((a: number, m: any) => a + (m.emailCount || 0), 0),   bg: "bg-purple-50", color: "text-purple-600" },
  ];
