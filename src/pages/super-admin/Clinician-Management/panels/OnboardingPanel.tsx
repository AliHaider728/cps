...
interface OnboardingState {
  ...
  mobilisationPlan: boolean;
  systemsRequested: boolean;
  smartcardOrdered: boolean;
  contractSigned: boolean;
  indemnityVerified: boolean;
  inductionBooked: boolean;
  notes: string;
      ...
      <div className="grid md:grid-cols-2 gap-3 mb-6">
        {CHECKLIST.map(([k, label]) => (
          <ToggleRow
            key={k}
            label={label}
            checked={!!state[k as keyof OnboardingState]}
