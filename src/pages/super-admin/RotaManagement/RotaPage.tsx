...
export default function RotaPage() {
  ...
  const [activeTab, setActiveTab] = useState<string>(safeInitialTab);
  ...
  const urgent = gaps.filter((gap: any) => gap.urgency === "urgent").length;
  const critical = gaps.filter((gap: any) => gap.urgency === "critical").length;
