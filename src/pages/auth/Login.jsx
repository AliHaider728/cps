      ...
      <div className="fn min-h-screen flex bg-gray-50 overflow-hidden">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-end p-12"
          ...
          <div className="relative z-30">
            ...
            <div className="flex gap-3">
              {[{number:"25+",label:"Years combined NHS experience"},{number:"PCNs",label:"Nationwide network supported"},{number:"100%",label:"Managed pharmacist model"}].map((s,i)=>(
        ...
        <div className="flex-1 flex flex-col justify-center items-center px-5 sm:px-8 md:px-12 py-8 bg-white relative overflow-y-auto">
          ...
          <div className="w-full max-w-md relative z-10">
            ...
            {error && (
              <div className="mb-5 flex items-center gap-3 px-4 py-3 bg-red-50 border border-red-200 rounded-xl shake">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-5">
                ...
                <div className="relative">
                  ...
                  <button type="button" onClick={()=>setShowPassword(!showPassword)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-slate-400 hover:text-blue-600 transition-colors bg-transparent border-none cursor-pointer flex items-center">
                    {showPassword
              ...
              <div className="flex items-center justify-between mb-7">
                ...
                <Link to="/forgot-password" className="text-sm text-blue-600 font-semibold hover:text-blue-800 hover:underline transition-colors">Forgot password?</Link>
              </div>
              <button type="submit" disabled={loading}
                ...
                style={{background:"linear-gradient(135deg,#2563eb 0%,#1d4ed8 100%)",boxShadow:loading?"none":"0 4px 14px rgba(37,99,235,0.3)"}}>
                <div className="flex items-center justify-center gap-2 relative z-10">
                  {loading ? <><div className="spinner"/><span>Signing in…</span></> : <><span>Sign In</span><svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg></>}
                </div>
              </button>
